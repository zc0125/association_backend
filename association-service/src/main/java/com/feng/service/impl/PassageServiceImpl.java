...
public class PassageServiceImpl implements PassageService {
    ...
    @Override
    public PageInfo<PassageDto> findPage(int pageNum, int pageSize, Passage search) {
        PageHelper.startPage(pageNum, pageSize);
        List<PassageDto> passageList = passageMapper.findPassage(search);
        return new PageInfo<>(passageList);
    }

    @Override
    public PageInfo<PassageDto> findPageByClubId(int pageNum, int pageSize, Passage search) {
        PageHelper.startPage(pageNum, pageSize);
        List<PassageDto> passageList = passageMapper.findPassageByClubId(search);
        return new PageInfo<>(passageList);
    }
