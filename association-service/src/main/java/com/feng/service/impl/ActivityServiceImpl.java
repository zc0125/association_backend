...
public class ActivityServiceImpl extends ServiceImpl<ActivityMapper, Activity> implements ActivityService {
    ...
    @Override
    public PageInfo<ActivityDto> getPage(int pageNum, int pageSize, Activity search) {
        PageHelper.startPage(pageNum, pageSize);
        List<ActivityDto> activityList = activityMapper.findActivity(search);
        return new PageInfo<>(activityList);
    }

    @Override
    public PageInfo<ActivityDto> getPageByClubId(int pageNum, int pageSize, Activity search) {
        PageHelper.startPage(pageNum, pageSize);
        List<ActivityDto> activityList = activityMapper.findActivityByClubId(search);
        return new PageInfo<>(activityList);
    }
